...
import {  getCategoryFilter,getPricedFilter,getRatedFilter,getsortedProducts } from "../utils/filter-utils";
    ...
    return(
      ...
      <Header/>
        ...
        <div className="grid-container">
          {categoryFilter.map((product)=> { return <ProductCard product={product}/>})}
          </div>
          </div>
